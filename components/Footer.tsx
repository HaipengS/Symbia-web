 ...
 *
 * Columns start at 0, 25, 67.57 and 84% of the content width. The band between the
    ...
    <footer className="bg-earth">
      <div className="mx-auto w-full max-w-[1720px] px-6 pb-20 pt-24 md:px-10 min-[1440px]:pt-[7.5rem] lg:px-14">
        {/* Tracks are the distance from one start to the next, so each block begins
            exactly on its percentage: 0, 25, 67.57 and 84%.
            ...
            Four columns only from 1440, and that number is a consequence of where
            Address sits, not a free choice. Percentage starts scale with the viewport,
            so the gap in front of Contact is the first thing a narrower one eats:
            104px at 1840, 58px at 1440, 7px at 1100. Every time Address moves right
            this breakpoint has to follow it. If this spacing is a keeper the tracks
            should become fixed px with a fixed gap, which holds at every width.
        ...
        <div className="grid grid-cols-1 gap-y-14 text-left min-[700px]:grid-cols-2 min-[700px]:gap-x-16 min-[1440px]:grid-cols-[25fr_42.57fr_16.43fr_16fr] min-[1440px]:items-start min-[1440px]:gap-x-0 min-[1440px]:gap-y-0">
